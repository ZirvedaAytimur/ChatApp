...
$messageForm.addEventListener('submit', (e) => { //send data from client to server
    e.preventDefault()

    $messageFormButton.setAttribute('disabled', 'disabled') // disable the form ones it submit it
